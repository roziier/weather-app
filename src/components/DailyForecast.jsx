    ...
    <>
        ...
        <div className='w-full min-[0px]:flex-wrap md:flex-nowrap flex justify-center items-center overflow-visible'>
            {forecast.map((f, index) => 
                <div key={index} className='py-5 min-[0px]:w-full md:w-36 flex min-[0px]:flex-row md:flex-col min-[0px]:justify-between md:justify-center items-center mx-4'>
                    <h1 className='min-[0px]:text-xs md:text-small lg:text-base lg:font-base'>{f.title}</h1>
                    <img className='size-18' src={f.icon} alt="img" />
